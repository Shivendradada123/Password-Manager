...
const Nav = () => {
  return (
       <div className='bg-gray-800 text-white flex justify-center  border-b boder-gray-700  p-3'>
            ...
            <button className='rounded-2xl  hover:bg-white hover:text-black py-1.5 px-4 font-medium border border-white' >Sign in</button>
            <button  className='rounded-2xl   py-1.5 px-4 border   hover:bg-white hover:text-black font-medium border-white text-white' >Sign up</button>
