  ...
  return (
       <div className='bg-gray-800 text-white flex justify-center  border-b boder-gray-700  p-3'>
            ...
            <div className='gap-7 flex items-center'>
                <input value={search} onChange={(e)=> setSearch(e.target.value)}  type="text" placeholder='Search Password'  className='rounded-2xl px-3 py-1 text-white border border-white-'   />
